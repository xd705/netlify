        ...
        >
          ...
          <Text fontFamily="Slackey" fontSize={["2xl", ,"4xl"]} color="blue.300">
               ...
               <Text   fontFamily="Open Sans" fontSize={["xl", ,"2xl"]} color="yellow.200">
                   -MozziTozzi smart contract is "0x831A1a934C623E6cBCfB3a82d7560D1C17769807". Which give's ability to minters to mint up to 10 random MZTs per transaction with less gas fee in total.
                   </Text>
               <Text   fontFamily="Open Sans" fontSize={["xl", ,"2xl"]} color="yellow.200">
